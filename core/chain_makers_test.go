...
/*
	...
	1. GenerateChain fails with EIP1559 transactions before activation
	2. GenerateChain works with both legacy and EIP1559 transactions between activation and finalization
	3. GenerateChain fails with legacy transactions after finalization
...
// generateChainAfterFinalization
